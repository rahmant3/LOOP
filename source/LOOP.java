...
public void drawButtons() {
  ...
  fill(75, 100, 200);
  rect(BORDER + WHITESP + 0, BORDER + WHITESP + 0, 100 - 1.2f* (WHITESP + BORDER), 100 - 2 * (WHITESP + BORDER));
  rect(BORDER + WHITESP + 100, BORDER + WHITESP + 0, 100 - 1.2f* (WHITESP + BORDER), 100 - 2 * (WHITESP + BORDER));
  rect(BORDER + WHITESP + 200, BORDER + WHITESP + 0, 100 - 1.2f* (WHITESP + BORDER), 100 - 2 * (WHITESP + BORDER));
  rect(BORDER + WHITESP + 300, BORDER + WHITESP + 0, 100 - 1.2f* (WHITESP + BORDER), 100 - 2 * (WHITESP + BORDER));
...
public void drawBoard(Board br) {
  noStroke();
